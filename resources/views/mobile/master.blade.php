...
<body class="home blog" cfapps-selector="body" style="background-color: #000">
    @include('mobile.template.header')
    <div>
        <div class="notice" style="z-index: 10000;padding: 10px 0px">
            <div style="width: 15%;float: left;">
                @if(env('BANNER_FULL', '0') == "1")
                    @if($ads_f1)
                        @foreach ($ads_f1 as $k)
                            <a href="{{ route('ads_redirect', ['id' => $k->id]) }}" target="_new" style="z-index: 10000">
                ...
                @elseif(env('BANNER_FULL', '0') == "0")
                    @if($ads_f1)
                        <a href="{{ route('ads_redirect', ['id' => $ads_f1->id]) }}" target="_blank" style="z-index: 10000">
            ...
            <div style="width: 15%;float: right;">
                ...
                @elseif(env('BANNER_FULL', '0') == "0")
                    @if($ads_r1)
                        <a href="{{ route('ads_redirect', ['id' => $ads_r1->id]) }}" target="_blank" style="z-index: 10000">
            ...
            @endforeach
            <p style="font-size: 10px">Thai = เสียงไทยมาสเตอร์, Thai(C) = เสียงไทยโรง, Soundtrack(T) = เสียงซาวด์แทรกซับไทย, Soundtrack(E) = เสียงซาวด์แทรกซับอังกฤษ</p>
        </div>
    ...
    @if(env('BANNER_FULL', '0') == "1")
        @if($ads_bbb)
        <div style="z-index: 10000; position: fixed; bottom: 0px; left: 0px; right: 0px; text-align: center;" id="show_ads_c1">
                ...
                <div style="position: relative; display: inline-block;"><a href="javascript: void(0);" style="cursor: pointer; position: absolute; top: 0px; right: -28px;">
                    ...
                    <a href="{{ route('ads_redirect', ['id' => $ads_bbb->id]) }}" target="_blank">
                        @if(strrpos($ads_bbb->image_ads , 'http') === false)
                            <img src="{{ asset($ads_bbb->image_ads) }}" alt="banner" style="width: 60vw; height: 9vh">
                        @else
    ...
    @if(env('BANNER_FULL', '0') == "1")
        @if($ads_aaa)
            <div id="aaa-banner-left" style="z-index: 10000; position: fixed; bottom: 0; left: 0; text-align: center;">
                ...
                <div style="position: relative; display: inline-block;">
                    ...
                    <a href="javascript: document.getElementById('aaa-banner-left').remove()" style="cursor: pointer; position: absolute; top: 0; right: -28px;">
                        ...
                        @if(strrpos($ads_aaa->image_ads , 'http') === false)
                            <img src="{{ asset($ads_aaa->image_ads) }}" alt="banner" style="width: 20vw">
                        @else
    ...
    @if(env('BANNER_FULL', '0') == "1")
        ...
        @if($ads_ccc)
            <div id="ccc-banner-left" style="z-index: 10000; position: fixed; bottom: 0; right: 0; text-align: center;">
                ...
                <div style="position: relative; display: inline-block;">
                    ...
                    style="cursor: pointer; position: absolute; top: 0; left: -28px;"><img
                        ...
                        @if(strrpos($ads_ccc->image_ads , 'http') === false)
                            <img src="{{ asset($ads_ccc->image_ads) }}" alt="banner" style="width: 20vw">
                        @else
