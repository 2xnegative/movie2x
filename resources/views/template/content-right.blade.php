<div class="content-right">
        ...
        <ul>
            @foreach ($category_menu as $k)
                <li class="cat-item cat-left">
                    <a href="{{ route('category', ['title' => str_replace(' ','-', $k->title_category)]) }}" title="{{ $k->title_category }}">
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="cat-item cat-left">
                <a href="{{ route('category', ['title' => str_replace(' ','-', $k->title_category)]) }}" title="{{ $k->title_category }} {{ $k->title_category }}">
                    {{ $k->title_category_eng }} {{ $k->title_category }}  @if($k->split == "1") <img src="{{ asset('images/hot.gif') }}" width="30px" alt="category-hot"> @endif
                </a>
            </li>
            @endforeach
